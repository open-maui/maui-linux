...
public class SkiaPolygon : SkiaView
{
    ...
    public static readonly BindableProperty StrokeDashArrayProperty =
        BindableProperty.Create(nameof(StrokeDashArray), typeof(DoubleCollection), typeof(SkiaPolygon), null,
            propertyChanged: (b, o, n) => ((SkiaPolygon)b).Invalidate());

    public static readonly BindableProperty StrokeDashOffsetProperty =
        BindableProperty.Create(nameof(StrokeDashOffset), typeof(double), typeof(SkiaPolygon), 0.0,
            propertyChanged: (b, o, n) => ((SkiaPolygon)b).Invalidate());
